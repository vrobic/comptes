...
class MouvementsImportController extends AbstractController
{
    ...
    /**
     * Affiche le formulaire d'import des mouvements.
     */
    #[Route('/import/mouvements', name: 'import_mouvements', methods: ['GET'])]
    public function index(): Response
    {
        return $this->render(
            ...
            [
                ...
                'categorized_mouvements' => new MouvementCollection(),
                'uncategorized_mouvements' => new MouvementCollection(),
                'ambiguous_mouvements' => new MouvementCollection(),
                'waiting_mouvements' => new MouvementCollection(),
            ]
        );
    }

    /**
     * Parse le fichier uploadé et affiche les mouvements à importer.
     *
     * @throws \Exception en cas d'erreur d'import du fichier
     */
    #[Route('/import/mouvements/parse', name: 'import_mouvements_parse', methods: ['POST'])]
    ...
    /**
     * Importe les mouvements après ajustements manuels.
     *
     * @throws BadRequestHttpException en cas d'erreur de validation
     */
    #[Route('/import/mouvements/import', name: 'import_mouvements_import', methods: ['POST'])]
