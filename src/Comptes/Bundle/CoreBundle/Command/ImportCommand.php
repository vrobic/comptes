...
abstract class ImportCommand extends ContainerAwareCommand
{
    ...
    {
        $configurationLoader = $this->getContainer()->get('comptes_core.configuration.loader');
    ...
    protected function getHandler($handlerIdentifier)
    {
        ...
        $handler = $this->getContainer()->get("comptes_core.import.$this->type.$handlerIdentifier");
