...
namespace Comptes\Bundle\CoreBundle\Command;
...
class MouvementsCategorizerFromPleinsCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $pleinRepository = $em->getRepository('ComptesCoreBundle:Plein');
        $mouvementRepository = $em->getRepository('ComptesCoreBundle:Mouvement');
        $categorieRepository = $em->getRepository('ComptesCoreBundle:Categorie');
